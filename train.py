...
from src.dataset.sample_processors import rnn_samples, semseg_aux_samples, test_samples
...
with skip_run('skip', 'ablation_study') as check, check():
    ...
    for images, command, loc in data_loader:
        attr = ablator.attribute(
            inputs=(images, command),
